...
// app/ra/report/[jobId]/page.tsx
//  "view output → chat/edit loop"
...
export default function RAReportPage() {
    ...
    <div className="flex h-[calc(100vh-5rem)] flex-col gap-4">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/ra/history">
            <ArrowLeftIcon className="h-4 w-4" />
          </Link>
        </Button>
        <PageHeader
          title="Report View"
          description="Acme Corporation — Executive Summary"
        />
      </div>
