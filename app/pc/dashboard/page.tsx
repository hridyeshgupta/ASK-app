...
// app/pc/dashboard/page.tsx
// Landing page for PC module
...
const RECENT_REPORTS = [
  { jobId: 'pc-job-001', companyName: 'GlobalTech Industries', section: 'Financial Analysis', status: 'completed', createdAt: '2026-04-09T10:00:00Z' },
  { jobId: 'pc-job-002', companyName: 'Atlas Infrastructure', section: 'Risk Assessment', status: 'completed', createdAt: '2026-04-08T15:30:00Z' },
  { jobId: 'pc-job-003', companyName: 'Quantum Ventures', section: 'Investment Thesis', status: 'completed', createdAt: '2026-04-07T12:00:00Z' },
];
      ...
      <Card className="border-border/50">
        <CardHeader className="flex flex-row items-center justify-between pb-4">
          ...
          <Button variant="ghost" size="sm" asChild>
            <Link href="/pc/history" className="gap-1">
              View all
